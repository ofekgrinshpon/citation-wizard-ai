...
const TASK_MODES: { id: TaskMode; label: string; description: string; placeholder: string; icon: LucideIcon }[] = [
  ...
  { id: "pleading_analysis", label: "מבקר מסמכים משפטיים", description: "ביקורת משפטית: דיוק אזכורים, סתירות לוגיות, ניתוח אדוורסרי", placeholder: "הדביקו או העלו מסמך משפטי (כתב טענה, חוזה, חוות דעת) לביקורת מקיפה...", icon: FileSearch },
