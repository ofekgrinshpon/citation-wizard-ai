...
const SOURCE_CATEGORIES: { key: SourceType; label: string; icon: string }[] = [
  ...
  { key: "correspondence", label: "התכתבות", icon: "✉️" },
  { key: "interview", label: "ריאיון", icon: "🎙️" },
  { key: "lecture", label: "הרצאה", icon: "🎤" },
  { key: "press_release", label: "הודעה לתקשורת", icon: "📢" },
  { key: "film", label: "סרט", icon: "🎬" },
  { key: "tv_show", label: "תוכנית טלוויזיה", icon: "📺" },
  { key: "radio", label: "רדיו/תסכית", icon: "📻" },
