...
function buildDocketLimitationDraft(
  ...
  return {
    blocks: [
      {
        kind: "paragraph",
        text: `לא אותר במקורות הזמינים פסק הדין עצמו בעניין ${target}. לכן לא ניתן לקבוע באופן מוסמך מה נקבע בו, מה היו הנימוקים או מה הייתה תוצאת ההליך. אין להשיב מתיקים דומים, ממקורות רקע או מספרות משנית.`,
        source_refs: [],
      },
      {
        kind: "paragraph",
