...
*** אסור לך בשום מקרה להמציא, לנחש, או לשער מספרי ס"ח, ק"ת, עמודים, כרכים, מספרי תיק, או תאריכים. ***
*** אם מספר ס"ח, עמוד פרסום, כרך, או כל מטא-נתון אחר אינו מסופק על ידי המשתמש או על ידי מקור מאומת מהמאגר – חובה להשתמש ב-[חסר: ...] ***
*** דוגמאות:
  - אם לא ידוע מספר ס"ח: כתוב ס"ח [חסר: מספר ס"ח]
  - אם לא ידוע עמוד פרסום: כתוב [חסר: עמוד בס"ח]
  - אם לא ידועה שנה עברית: כתוב [חסר: שנה עברית]
***
*** לעולם אל תכתוב מספר ס"ח או עמוד שלא סופק במפורש. מספר שגוי גרוע מ-[חסר:...]. ***
