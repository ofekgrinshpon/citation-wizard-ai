...
const CITATION_ENGINE_TEMPLATES: Record<string, { rule: string; template: string; required: string[] }> = {
  ...
  "הצעת חוק": {
    rule: "כלל 8",
    template: 'הצעת חוק {שם}, {שנה עברית}-{שנה לועזית}, ה"ח {סוג} {מספר חוברת}, {עמוד}.',
    required: ["שם הצעת החוק", "שנה עברית", "שנה לועזית", "מספר חוברת", "עמוד ראשון"],
  },
  "הצעת חוק יסוד": {
    rule: "כלל 8",
    template: 'הצעת חוק-יסוד: {שם}, {שנה עברית}, ה"ח {סוג} {מספר חוברת}, {עמוד}.',
    required: ["שם הצעת חוק היסוד", "שנה עברית (ללא שנה לועזית)", "מספר חוברת", "עמוד ראשון"],
    notes: "בהצעות חוק יסוד מציינים שנה עברית בלבד, ללא שנה לועזית.",
  },
  "פסיקה (דפוס)": {
    rule: "כלל 18",
