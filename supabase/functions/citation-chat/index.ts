...
const CITATION_ENGINE_TEMPLATES: Record<string, { rule: string; template: string; required: string[] }> = {
  ...
  "מקור לועזי": {
    ...
    template: "לפי כללי ה-Bluebook (מהדורה 22).",
...
דמות ועמדה מקצועית:
אתה מומחה לכללי האזכור האחיד בעברית ובלועזית. אתה יודע את כל כללי הבלובוק (מהדורה 22) לגבי מקורות לועזיים. אתה שולט בכל נוסחאות האזכור לפי הכללים.
