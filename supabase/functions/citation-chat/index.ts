...
- הצעות חוק רגילות (כלל 8): שם הצעת החוק, שנה עברית ולועזית, מספר חוברת, עמוד ראשון. הקיצור התקני הוא ה"ח (לא הצ"ח!).
- הצעות חוק יסוד (כלל 8): שם הצעת חוק היסוד, שנה עברית בלבד (ללא שנה לועזית!), מספר חוברת, עמוד ראשון. הקיצור התקני הוא ה"ח.
