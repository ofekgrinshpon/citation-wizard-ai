...
const CITATION_ENGINE_TEMPLATES: Record<string, { rule: string; template: string; required: string[] }> = {
  ...
  "מועצת המדינה הזמנית": {
    ...
    required: ["כרך באותיות עבריות", "מספר ישיבה", "עמוד", "תאריך לועזי מלא (יום.חודש.שנה)"],
    notes: 'מקורות מכרכי מועצת המדינה הזמנית. מספר הכרך באותיות עבריות (א, ב, ג...). דוגמה: מועצת המדינה הזמנית א, ישיבה ב, 9 (5.5.1948).',
  },
};
