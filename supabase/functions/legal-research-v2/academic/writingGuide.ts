...
export const ACADEMIC_BODY_CHAPTER_GUIDE =
  `אתה כותב פרק גוף בעבודה אקדמית משפטית ישראלית, לא תשובה לשאלה. סגנון: פרוזה אקדמית עברית רהוטה ומדודה, בגוף שלישי, ללא פנייה לקורא וללא דיווח על תהליך המחקר או על החיפוש.
