...
- identity_evidence שמוחזר ב-fetch הוא הוכחת זהות המסמך בלבד (כותרת הליך, מספר תיק, בעלי דין, ערכאה, או פרטי פרסום אקדמיים). זהות המסמך נבדקת אצלנו אוטומטית מתוך הגוף השמור — אל תבזבז עליה ראיות: quoted_span צריך לשאת תוכן משפטי מהותי לטענה, לא כותרת או פרטי זיהוי.
- כותרת, קישור או תקציר מתוצאות חיפוש לעולם אינם מוכיחים שמסמך הוא מה שהוא מתיימר להיות. רק הגוף שהובא בפועל קובע.
