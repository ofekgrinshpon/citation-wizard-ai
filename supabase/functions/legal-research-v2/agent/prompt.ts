...
- אם קיבלת הודעה שסעיף אינו נמצא במקור, שנתיב הבאה כבר נכשל, או שמיצית מקור (search_path_exhausted) — אל תנסח מחדש את אותה בקשה על אותו מקור. עבור למקור אחר או לנתיב השגה אחר.
