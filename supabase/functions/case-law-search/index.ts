...
שלב 1 — זיהוי: התחל מ-https://lite.takdin.co.il/search-results?txtSearch=<מספר התיק>. דף התוצאות חושף בתקציר את שמות הצדדים, בית המשפט, וקידומת מספר התיק (למשל "תא (ראשון לציון) 13579-11-24").
