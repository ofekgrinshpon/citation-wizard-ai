...
שאלה: "פרשנות חוזים — הלכת אפרופים"
אסמכתאות צפויות:
- A1 leading_case: 'ע"א 4628/93 מדינת ישראל נ' אפרופים שיכון ויזום', docket: 'ע"א 4628/93', centrality: seminal.
- A2 leading_case: 'דנ"א 2045/05 ארגון מגדלי ירקות נ' מדינת ישראל', docket: 'דנ"א 2045/05', centrality: seminal.
- A3 statute_section: 'חוק החוזים (חלק כללי), התשל"ג–1973', section: 'סעיף 25' (לאחר תיקון מס' 2, תשע"א–2011), centrality: seminal.

שאלה: "צו מניעה זמני — תנאים"
אסמכתאות צפויות:
- A1 regulation: 'תקנות סדר הדין האזרחי, התשע"ט–2018', section: 'תקנה 95' (לרבות תקנה 95 הישנה), centrality: seminal.
- A2 statute_section: 'חוק בתי המשפט [נוסח משולב], התשמ"ד–1984', section: 'סעיף 75', centrality: seminal.
- A3 leading_case: פסק דין מנחה בסוגיית הסעדים הזמניים (למשל רשות לערער/וולטה/מרכנתיל אם אתה בטוח), centrality: seminal.
