...
- חוקים/תקנות — כתוב שם מדויק כולל שנה (למשל: 'חוק החוזים (חלק כללי), התשל"ג–1973').
- פסיקה — כתוב סוג הליך + מספר תיק + שמות צדדים מרכזיים. אם אינך בטוח במספר התיק או בשמות הצדדים — אל תכלול את האסמכתא. השמטה עדיפה על המצאה.
...
- אסור להמציא. אם אינך מכיר את האסמכתא ברמה של ודאות סבירה — השמט אותה.
