...
- **סמן `[חסר: ...]` אינו "כיסוי"** להיעדר מקור. הוא מותר אך ורק כשיש בידך מקור אמיתי וניתן לקישור, וחסר ממנו פרט בודד (עמוד, שנה, כרך). אסור לבנות הערה שכולה שלד של `[חסר: ...]` סביב כותרת בלי anchor אמיתי.
