...
2. כל הערת שוליים חייבת להתבסס על מקור אמיתי מתוצאות החיפוש שסופקו.
3. אל תמציא מקורות. אם אין מקור מתאים, ציין זאת.
4. סווג כל מקור לפי סוג: legislation (חקיקה), caselaw (פסיקה), book (ספר), article (מאמר), international (בינלאומי).
5. בציטוט פסיקה, ציין מספר תיק מדויק אם זמין.
6. בציטוט חקיקה, ציין שם החוק המלא ושנת הפרסום.
7. עבור מידע שאינך בטוח לגביו, השתמש ב-[missing:פרט חסר].
