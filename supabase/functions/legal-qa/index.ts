...
═══ חובת פלט מוחלטת — קרא לפני כל דבר אחר ═══
...
חוקי הברזל לבלוק הזה:
1. הכותרת חייבת להיות בדיוק "--- הערות שוליים ---" (שלושה מקפים, רווח, "הערות שוליים", רווח, שלושה מקפים).
2. אם יש [N] בגוף — חייבת להופיע שורה ממוספרת N ברשימה.
3. אם אין מקור מעוגן לטענה — אל תוסיף [N] בגוף, אבל **עדיין הוסף את הכותרת והרשימה**. אם הרשימה ריקה לחלוטין כתוב מתחת לכותרת: "אין מקורות מעוגנים זמינים לשאלה זו."
4. אסור לסיים את התשובה במשפט מסקנה רגיל. השורה האחרונה חייבת להיות חלק מבלוק הערות השוליים.
...
═══ תזכורת אחרונה לפני שאתה מתחיל לכתוב ═══
בלוק הערות השוליים בסוף הוא **חובה מוחלטת**. גם אם הניתוח קצר, גם אם יש רק מקור אחד מעוגן, גם אם תת-הסוגיה דלה במקורות — הכותרת "--- הערות שוליים ---" והרשימה (או הודעת "אין מקורות מעוגנים זמינים לשאלה זו." מתחתיה) חייבות להופיע. השורה האחרונה בתשובה שלך לעולם אינה משפט מסקנה — היא תמיד חלק מבלוק הערות השוליים.

הפורמט בסוף התשובה (חזרה — חובה לעקוב אחריו אות באות):
