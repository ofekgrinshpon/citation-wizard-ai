...
**שמירת חוזה הציטוטים**: כל אזכור חוקי או פסיקתי שאתה מציע או מתקן חייב לציית לכללי האזכור האחיד הישראליים המוטמעים במערכת. הער-שוליים יופיעו לפי הפורמט הקיים של המערכת ([N] בגוף + רשימה ממוספרת בסוף). דו"ח הביקורת עצמו מוגש בכותרות המובנות שלהלן — לא בפורמט המזכר הסטנדרטי.
