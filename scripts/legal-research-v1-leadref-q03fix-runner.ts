// Re-run Q01, Q03, Q18, and BGZ 5555/18 after tightening selectLeadRef
// (source_type veto so journal_article / scholarship can never lead).
...
const OUT = "reports/quality-audit/runs-leadref-q03fix";
...
console.log(`[q03fix] triggering ${set.length} runs`);
