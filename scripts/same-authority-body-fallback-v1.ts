...
mkdirSync("reports/same-authority-body-fallback-v1", { recursive: true });
writeFileSync("reports/same-authority-body-fallback-v1/run.json", JSON.stringify({ run_id: t.run_id, row }, null, 2));
