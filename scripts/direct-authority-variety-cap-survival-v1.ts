...
mkdirSync("reports/direct-authority-variety-cap-survival-v1", { recursive: true });
writeFileSync("reports/direct-authority-variety-cap-survival-v1/run.json", JSON.stringify({ run_id: t.run_id, row }, null, 2));
