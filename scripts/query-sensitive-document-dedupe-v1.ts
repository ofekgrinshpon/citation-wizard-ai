...
mkdirSync("reports/query-sensitive-document-dedupe-v1", { recursive: true });
writeFileSync("reports/query-sensitive-document-dedupe-v1/run.json", JSON.stringify({ run_id: t.run_id, row }, null, 2));
