...
mkdirSync("reports/direct-authority-pool-survival-v1", { recursive: true });
writeFileSync("reports/direct-authority-pool-survival-v1/run.json", JSON.stringify({ run_id: t.run_id, row }, null, 2));
