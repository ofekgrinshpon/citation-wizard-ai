// substance_based_doctrinal_sufficiency_v1 — acceptance validation runner.
...
const OUT = "reports/doctrinal-sufficiency";
...
console.log("[doctrinal-sufficiency] done ->", OUT);
