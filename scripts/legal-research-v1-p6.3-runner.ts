// P6.3 smoke runner — runs all 6 fixtures, persists per-fixture reports +
// a summary report to /dev-server/reports/. Mirrors P5 runner shape and adds
// the acceptance-check fields required for P6.3 sign-off.
//
// Usage:  bun scripts/legal-research-v1-p6.3-runner.ts
