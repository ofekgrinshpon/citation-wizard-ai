...
const OUT = "reports/nomination-toolcall-reliability";
...
for (const q of QUERIES) {
  ...
  console.log(`[${q.id}] terminal=${rec.terminal} nom_cands=${rec.source_nomination.candidates_count} esc=${rec.source_nomination.escalated} parse_error=${rec.source_nomination.parse_error} fn=${rec.footnotes_count} ${rec.ms}ms`);
}
